...
public class NiuchanPostsParser implements GroupParser.Callback
{
	private final String mSource;
	private final NiuchanChanConfiguration mConfiguration;
	private final NiuchanChanLocator mLocator;
	...
	public NiuchanPostsParser(String source, Object linked, String boardName)
	{
	...
	public NiuchanPostsParser(String source, Object linked, String boardName, String parent)
	{
			...
			case EXPECT_NAME:
			{
				...
				if (matcher.matches())
				{
					...
					if (email.toLowerCase(Locale.US).equals("mailto:sage") ||
							...
							email.toLowerCase(Locale.US).equals("mailto:sabbia"))
					{
						mPost.setSage(true);
					}
