...
public class NiuchanChanConfiguration extends ChanConfiguration
{
	...
	public NiuchanChanConfiguration()
	{
	...
	public Board obtainBoardConfiguration(String boardName)
	{
		...
		//board.allowDeleting = !"rd".equals(boardName);
	...
	public Posting obtainPostingConfiguration(String boardName, boolean newThread)
	{
		...
		if ("rd".equals(boardName)) posting.attachmentMimeTypes.add("video/webm");
